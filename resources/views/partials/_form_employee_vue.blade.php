<div class="row" id="form">
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-check-square-o"></i> 填写人员基本信息</div>
            <div class="panel-body form-horizontal" style="min-height: 380px;">
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">人员姓名</label>
                    <div class="col-sm-9">
                        <input type="text" name="name" id="name" v-on="keyup:genPinyin"  class="form-control" placeholder="请填写姓名...">
                    </div>
                </div>
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">姓名简写</label>
                    <div class="col-sm-9">
                        <input type="text" name="pinyin" id="pinyin" v-model="pinyin" class="form-control" placeholder="通常这里会自动生成...">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group date datepicker" >
                            <input type='text' class="form-control" id="reached_at" data-date-format="YYYY-MM-DD"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="memo" class="form-control" id="memo" rows="2"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-check-square-o"></i> 填写护照签证信息</div>
            <div class="panel-body form-horizontal" style="min-height: 380px;">
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">护照编号</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="passport" placeholder="请填写护照号码...">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group date datepicker" >
                            <input type='text' class="form-control" id="passport_date" data-date-format="YYYY-MM-DD" placeholder="请选择或填写发照日期"/>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
						</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group date datepicker" >
                            <input type='text' class="form-control" id="passport_deadline" data-date-format="YYYY-MM-DD" placeholder="请选择或填写截止日期"/>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
						</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group date datepicker" >
                            <input type='text' class="form-control" id="visa_deadline" data-date-format="YYYY-MM-DD" placeholder="请选择或填写签证日期"/>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
						</span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group date datepicker" >
                            <input type='text' class="form-control" id="land_deadline" data-date-format="YYYY-MM-DD" placeholder="请选择或填写落地签日期"/>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
						</span>
                        </div>
                    </div>
